...
create table if not exists Messages (
  ...
  MessageBox enum('IN','OUT') default 'OUT',
  index idx_message_user1 (UserDepositaryId),
  index idx_message_user2 (UserApplicantId),
  constraint foreign key fk_message_user1(UserDepositaryId) references MainUser(Id),
  constraint foreign key fk_message_user2(UserApplicantId) references MainUser(Id),
